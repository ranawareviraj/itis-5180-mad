...
public class ProfileFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.textViewName.setText("Name: " + mProfile.getName());
        binding.textViewEmail.setText("Email: " + mProfile.getEmail());
        binding.textViewID.setText("ID: " + mProfile.getId() + "");
        binding.textViewProfileDepartment.setText("Department: " + mProfile.getDepartment());
    }
}